@php
    ...
    $publicUrl = \Illuminate\Support\Facades\URL::signedRoute('public.receptions.show', [
        'reception' => $selectedReception->id,
    ]);
...
<div class="p-4" id="receptionDetailsContent">
    <div class="{{ $showHeader ? '' : 'd-none d-print-block' }} mb-4">
        ...
        <div class="text-center mt-3">
            <h2 class="mb-1">RÉCEPTION FOURNISSEUR</h2>
            <div class="mb-0">REF: {{ $selectedReception->reference }}</div>
            <div class="mb-0">{{ \Carbon\Carbon::parse($selectedReception->date_reception)->format('d/m/Y') }}</div>
        </div>
        <hr class="mt-3 mb-0">
    </div>
