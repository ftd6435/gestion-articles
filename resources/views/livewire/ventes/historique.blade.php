        ...
        <div class="row g-3 align-items-center">
            ...
            <div class="col-12 col-lg-6">
                <div class="d-flex align-items-center mb-2">
                    ...
                    <div>
                        <h4 class="fw-bold mb-1">Historique & Analytics des Ventes</h4>
                        <small class="text-muted">
                            <i class="fas fa-filter me-1"></i>
                            @if ($search || $status || $date_from || $date_to || $client_id || $devise_id)
                                Ventes filtrées
                            @else
            ...
            <div class="col-12 col-lg-6">
                <div class="d-flex flex-column flex-sm-row gap-2 justify-content-lg-end">
                    <div class="flex-grow-1 flex-sm-grow-0">
                        <select class="form-select" wire:model.live="devise_id">
                            @foreach ($devises as $devise)
                                <option value="{{ $devise->id }}" {{ $devise_id == $devise->id ? 'selected' : '' }}>
        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-2">
                    ...
                    <input type="date" class="form-control" wire:model.live="date_from" max="{{ date('Y-m-d') }}">
                </div>
                ...
                <div class="col-md-2">
                    ...
                    <input type="date" class="form-control" wire:model.live="date_to" max="{{ date('Y-m-d') }}">
                </div>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <small class="text-muted">{{ $client['ventes_count'] }}
                                                            ventes</small>
                                                    </div>
                                                </div>
                                                <div class="text-end">
                                                    <div class="fw-bold">
                                                        {{ number_format($client['total_amount'], 0, ',', ' ') }}
                                                        {{ $currency }}
                                                    </div>
                                                    <small class="text-muted">
                                                        @if ($totalNet > 0)
        ...
        <div class="card-header bg-white border-0">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="text-muted small">
                    Affichage {{ $ventes->firstItem() ?? 0 }} à {{ $ventes->lastItem() ?? 0 }} sur
                    {{ $ventes->total() }} ventes
                </div>
            </div>
        </div>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <div class="btn-group btn-group-sm" role="group">
                                    <button class="btn btn-outline-primary" wire:click="showDetails({{ $vente->id }})"
                                        title="Voir détails">
