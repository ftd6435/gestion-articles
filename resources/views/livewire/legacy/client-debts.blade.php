<div>
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4">
        <div class="mb-3 mb-md-0">
            <h1 class="h3 fw-bold mb-1">Anciens - Dettes clients</h1>
            <p class="text-muted mb-0">Suivi des dettes importées depuis les cahiers</p>
        </div>
        <div class="d-flex gap-2">
            <button class="btn btn-outline-secondary" type="button" onclick="printElementById('legacy-client-debts-print')">
                <i class="fas fa-print me-2"></i> Imprimer
            </button>
            @access('legacy.clients', 'create')
            ...
            <div class="row g-3 align-items-center">
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Rechercher client (nom/téléphone/email)..."
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        @forelse($debts as $debt)
                            ...
                            <tr>
                                <td>
                                    <div class="fw-semibold">{{ $debt->client?->name ?? '—' }}</div>
                                    <div class="text-muted small">{{ $debt->client?->telephone ?? '' }}</div>
                                </td>
                ...
                <div class="modal-content shadow-lg bg-white rounded">
                    <div class="modal-header p-4 bg-primary">
                        <h5 class="modal-title text-white">
                            {{ $debtId ? 'Modifier une dette client' : 'Nouvelle dette client' }}
                        </h5>
            ...
            <div class="modal-dialog modal-dialog-centered bg-white" style="max-width: 900px;">
                <div class="modal-content shadow-lg bg-white rounded">
                    <div class="modal-header p-4 bg-success">
                        <h5 class="modal-title text-white">Paiements - Dette client</h5>
                        <button type="button" class="btn-close btn-close-white" wire:click="closePaymentModal"></button>
                    </div>
                    <div class="modal-body p-4">
                        <div class="d-flex flex-column flex-md-row justify-content-between gap-2 mb-3">
                            <div>
                                <div class="fw-semibold">{{ $paymentDebt?->client?->name ?? '—' }}</div>
            ...
            <div class="modal-dialog modal-dialog-centered bg-white" style="max-width: 980px;">
                <div class="modal-content shadow-lg bg-white rounded">
                    <div class="modal-header p-4 bg-dark">
                        <h5 class="modal-title text-white">Détails - Dette client</h5>
                        <div class="d-flex gap-2">
                            <button type="button" class="btn btn-light btn-sm" onclick="printElementById('legacy-client-debt-detail-print')">
                    ...
                    <div class="modal-body p-4">
                        <div id="legacy-client-debt-detail-print">
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-6">
                                    <div class="border rounded p-3">
                                        ...
                                        <div class="fw-semibold">{{ $viewDebt?->client?->name ?? '—' }}</div>
                                        <div class="text-muted small">{{ $viewDebt?->client?->telephone ?? '' }}</div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="border rounded p-3">
    ...
    <div class="d-none">
        <div id="legacy-client-debts-print">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div class="d-flex align-items-center gap-2">
                    @if($companyLogoUrl)
                        <img src="{{ $companyLogoUrl }}" alt="Logo" style="height: 36px;">
            ...
            <div class="mb-3">
                <div class="fw-bold">Liste - Dettes clients</div>
                <div class="text-muted small">
                    Statut: {{ $statusLabel }}
                    @if($dateFrom && $dateTo)
