        ...
        <div class="row g-3 align-items-center">
            ...
            <div class="col-lg-6">
                <div class="d-flex justify-content-end align-items-center gap-3">
                    ...
                    <!-- Add Button -->
                    <div>
                        <button class="btn btn-primary px-4 py-2 d-flex align-items-center" wire:click="openCreateModal">
                        ...
                        @forelse ($users as $user)
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        @if($user->image)
                                            <img class="rounded-circle me-3" src="{{ asset($user->image) }}" alt="{{ $user->name }}" width="40" height="40">
                                        @else
                                    ...
                                    <div class="d-flex justify-content-end gap-2">
                                        ...
                                        @if($currentUser->isSuperAdmin() || $currentUser->isAdmin())
                                            @if($user->id !== $currentUser->id)
                                                <button
                                                    wire:click="confirmStatusChange({{ $user->id }})"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content shadow-lg bg-white rounded">
                    ...
                    <div class="modal-body p-4">
                        ...
                        @error('newRole') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        <p class="text-muted small mt-3 mb-0">
                            <i class="fas fa-info-circle me-1"></i> Seul un super administrateur peut modifier les rôles.
                        </p>
                    </div>
                    <div class="modal-footer p-4">
                        <button class="btn btn-light me-2" wire:click="cancelConfirmation">Annuler</button>
                        <button class="btn btn-primary"
                                wire:click="updateUserRole({{ $confirmingRoleChange }})"
